    ...
    >
      ...
      <div className="section-shell relative grid w-full items-center gap-10 lg:grid-cols-[1.05fr_1fr] xl:gap-14">
        ...
        <div className="relative hidden lg:block">
          ...
          />
          <div className="relative origin-top scale-[0.9] xl:scale-95">
            <DashboardPreview />
          </div>

          <div className="absolute -left-8 bottom-10 w-52 rounded-2xl border border-white/15 bg-[oklch(0.2_0.03_258/0.85)] p-3 shadow-lifted backdrop-blur-md">
          ...
          <div className="absolute -right-4 top-8 flex w-44 items-center gap-3 rounded-2xl border border-white/15 bg-[oklch(0.2_0.03_258/0.85)] p-3 shadow-lifted backdrop-blur-md">
          ...
          <div className="absolute -bottom-4 right-8 inline-flex items-center gap-2 rounded-full border border-white/15 bg-[oklch(0.2_0.03_258/0.85)] px-3 py-1.5 text-[11px] font-medium text-white/80 shadow-lifted backdrop-blur-md">
